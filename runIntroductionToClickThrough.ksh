...
# Module, element 2 Variables 

clickThroughPosition=$2
clickThroughStatus=$3
...
./snowsql -q "select elementid from modules where elementposition = '2' and moduleid = $moduleID;"  > result
...
completionTime=`date`
./snowsql -q "INSERT INTO UIDAUDIT (UID,MEDIATYPE,MODULE,LEARNINGJOURNEY,LEARNINGJOURNEYID,MODULEID,ELEMENTID,ELEMENTSTATUS,COMPLETIONTIME,SCREENIDNUMBER) VALUES ($userID,'$elementIDType','Introduction to Markets','MVP',1,$moduleID,$elementIDToRun,'$clickThroughStatus','$completionTime','$clickThroughPosition');"
